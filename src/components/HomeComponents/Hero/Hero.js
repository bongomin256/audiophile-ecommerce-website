...
function Hero() {
  ...
  return (
    <>
      <section className="relative h-screen px-8 bg-no-repeat bg-contain bg-mobileHeade md:h-[80vh] md:px-10 md:bg-tabletHeader lg:bg-desktopHeader  lg:px-40 lg:h-screen ">
        <div
