...
const Zx9Speaker = () => {
  return (
    <section className="px-8 mt-[2.2rem] md:px-16 lg:px-28">
      <div className="flex flex-col gap-8 px-8 py-12 m-auto bg-orange-300 rounded-md lg:flex-row lg:items-center lg:px-28">
        <div className="m-auto grow">
          <picture>
            <source media="(min-width: 768px)" srcset={zx9Tablet} alt="" />
            <source media="(min-width: 1024pxpx)" srcset={zx9Desktop} alt="" />
            <img src={zx9Mobile} alt="" />
          </picture>
        </div>
        <div className="flex flex-col gap-8 grow">
          <div className="m-auto text-center md:w-72 md:text-center lg:text-left lg:m-0">
            <h2 className="text-5xl font-medium text-white uppercase font-monrope md:font-bold md:text-6xl">
              zx9 speaker
            </h2>
          </div>
